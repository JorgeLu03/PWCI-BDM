...
│       └── registro.php
│
├── html/                                # Bootstrap files (entry points)
│   ├── administrar_publis.php           # Admin panel bootstrap
│   ├── buscar.php                       # Search bootstrap
│   ├── categoria.php                    # Category detail bootstrap
│   ├── categorías.php                   # Categories list bootstrap
│   ├── cerrar_sesion.php                # Logout bootstrap
│   ├── comentarios_publi.php            # Comments bootstrap
...
│   ├── mundial_detalle.php              # World Cup detail bootstrap
...
### 4. **Bootstrap Pattern**
- Archivos en `html/` son entry points mínimos (8-12 líneas)
...
- **23 Bootstrap Files**: Entry points en `html/`
...
4. Acceder a `http://localhost/BDM-PWCI/CapaIntermedia-main/html/inicio.php`
...
- Código inline de DB en todos los archivos `html/*.php`
