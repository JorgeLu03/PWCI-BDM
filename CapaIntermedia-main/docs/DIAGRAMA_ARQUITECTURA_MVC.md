...
public/            23 archivos    (~8 líneas c/u)   = ~184 líneas
                   ────────────────────────────────────────────────
                   TOTAL: 65 archivos PHP           ~7,049 líneas
```
...
**Bootstrap (public/inicio.php) - 8 líneas**
```php
<?php
session_start();
...
**API Handler (public/like_handler.php) - 7 líneas**
```php
<?php
session_start();
