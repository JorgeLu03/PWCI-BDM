...
### 5. Bootstrap Files (23 archivos)
```
public/
├── administrar_publicaciones.php   (11 líneas)
├── buscar.php                      (8 líneas)
├── categoria.php                   (8 líneas)
├── categorias.php                  (8 líneas)
├── cerrar_sesion.php               (6 líneas)
├── comentarios_publicacion.php     (8 líneas)
...
### 4. Bootstrap Pattern ✅
- Entry points mínimos en `public/` (directorio público estándar)
- Cada archivo instancia su controlador y llama a `handle()`
- Separa punto de entrada público de lógica de aplicación
