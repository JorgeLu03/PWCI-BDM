                ...
                <div class="worldcup-container" id="comment-<?php echo $comment['ID_Coment']; ?>">
                    <div class="worldcup-info comment">
                        ...
                        <div class="post-meta" style="margin-top: 10px;">
                            <span>En la publicación: <a href="comentarios_publicacion.php?id=<?php echo $comment['ID_Publi']; ?>" target="_blank"><strong><?php echo htmlspecialchars($comment['TituloPublicacion']); ?></strong></a></span>
                        </div>
                    </div>
                    <div class="post-actions">
