...
<aside class="sidebar left-sidebar" id="leftSidebar">
    <ul>
        ...
        <?php if ($userType === 0): ?><li><a href="administrar_publicaciones.php"><i class="fa-solid fa-user-tie"></i> <span>Administrar</span></a></li><?php endif; ?>
    ...
    <div class="publicacion-container">
        ...
        <form class="publicacion-form" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" id="titulo" name="Titulo" class="form-input" placeholder="Ej: Argentina gana el partido contra Brasil" required>
            </div>
            <div class="form-group">
                <label for="contenido"><i class="fas fa-align-left"></i> Contenido</label>
                <textarea id="contenido" name="Descripcion" class="form-textarea" placeholder="Escribe el contenido de tu publicación..." required></textarea>
            </div>
            <div class="form-group">
                ...
                <div class="categoria-tags">
                    <select name="ID_Mundial" class="categoria-tag" required>
                        ...
                        <?php foreach ($mundiales as $mun): ?>
                            <option value="<?php echo htmlspecialchars($mun['ID']); ?>"><?php echo htmlspecialchars($mun['Nombre']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="file-upload" id="uploadArea">
                    <button type="button" class="btn btn-upload" onclick="document.getElementById('mediaFile').click()"><i class="fa-solid fa-photo-film"></i> Seleccionar archivos</button>
                    <input type="file" id="mediaFile" name="Multimedia" class="file-input" accept="image/*,video/*">
                    <div class="media-preview" id="mediaPreview"></div>
                </div>
            </div>
            <div class="form-buttons">
                <button type="button" class="btn btn-secondary" onclick="window.location.href='inicio.php'"><i class="fas fa-times"></i> Cancelar</button>
